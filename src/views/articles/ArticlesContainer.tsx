    ...
    <div>
      <Tab.Group>
        <Tab.List className={`relative `} >
          ...
          <div className="inline absolute right-0 lg:w-32 origin-top-right rounded-sm bg-gray-200 shadow-sm ring-1 ring-black ring-opacity-5 focus:outline-none text-xs md:text-sm lg:text-base">
